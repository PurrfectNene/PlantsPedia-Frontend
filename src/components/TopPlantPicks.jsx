...
function TopPlantPicks() {
  ...
  return (
    <div className="container-fluid text-center" style={{color: '#474443'}} >
      <div className="row p-5" style={{backgroundColor: '#e8ebe8'}}>
        <h2>Recently Added Plants</h2>
        <p className="fs-5 mt-5">Check out what our users have most recently added into our catalogue.</p>
