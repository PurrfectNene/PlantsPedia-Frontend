          ...
          <div className="container">
            <div className="row justify-content-end">
              <div className='col-lg-6' >
                <h1 className="text-uppercase text-center" style={{fontSize:'5rem', color:'#474443', display: "block", letterSpacing: '-8px'}} >Cultivate wisdom. Nurture your houseplants.</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mt-5" >
        <div className="row justify-content-center">
          <div className="col-md-4 mx-4 mb-5 card pt-4" style={{backgroundColor: '#EACCA6', border: 'none'}}>
            <Link to="/plants"><h2 className="text-center fs-1" style={{color: "#214624", letterSpacing: '-4px'}}>View All Plants</h2></Link>
