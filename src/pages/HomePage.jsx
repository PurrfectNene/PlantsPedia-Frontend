          ...
          <div className="container-fluid">
            <div className="row justify-content-end">
              <div className='col-lg-6 col-md-10 col-sm-10 col-xs-10' >
                <h1 className="text-uppercase text-sm-right text-md-right" style={{fontSize:'4.7rem', color:'#474443', display: "block", letterSpacing: '-8px', textAlign: 'right'}} >Cultivate wisdom.<br></br>Nurture your houseplants.</h1>
            </div>
          </div>
        </div>
      </div>

      <div className="container-fluid d-flex text-center p-5 vw-100" style={{backgroundColor: '#bdc6b3'}}>
        <div className="row">
